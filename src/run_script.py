...
from src.database_scripts import three_nf
from src.read_csv_file import read_csv_file as reader
from src.database_scripts.remove_card_data import remove_card_data as remove
...
def etl(filename):
    ...
    quantity = merger.ord_prod_table(return_dict_to_df) # gets customer_id, hash
    ...
    data_ord_prod_dict = merger.ready_ord_prod_db(product_db, return_dict_to_df, tab_order_id, quantity, transform.convert_df_to_dict)
